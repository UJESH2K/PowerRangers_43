    ...
    <main className="flex-1 p-8">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <ExerciseCard icon={<FileBarChart size={24} />} title="Deadlift" accuracy={85} />
          <ExerciseCard icon={<Sandwich size={24} />} title="Bicep Curl" accuracy={72} />
          <ExerciseCard icon={<Dumbbell size={24} />} title="Squats" accuracy={93} />
        </div>
      </section>
    </main>
  </div>
